...
fit
modelsummary(list(fit))
```
As the percentage of fox news subscribers in a town increases by 1 percentage point, the share in Gop votes as a percentage decreases by 0.07 percentage points. There is a slight negative correlation between fox news subscribers and the GOP vote share in a town in the 2000 election. 
